package Prj2.java.DAO;

import Prj2.java.model.*;
...
public class SaveToExcel
{
    ...
    private ArrayList<ToaThuoc> listToa = new ArrayList<>();
    private final String excelPath = "Prj2/java/DAO/QLTuThuoc.xlsx";
    public  ArrayList<Product> getExcelFileDemo() throws Exception
    {
        ...
        while (iteratorThuoc.hasNext()) {
            ...
            if(!isRowEmpty(nextRow)){
                ...
                LocalDate expiredDate = nextRow.getCell(5).getDateCellValue().toInstant()
                        ...
                        .toLocalDate();
                listProduct.add(new Thuoc(productID,name,unit,quantity,expiredDate,effect));
            }
        }
        while (iteratorDC.hasNext()) {
            ...
            if(!isRowEmpty(nextRow)){
                ...
                String unit = nextRow.getCell(3).getStringCellValue();
                String effect = nextRow.getCell(4).getStringCellValue();
                listProduct.add(new DungCu(productID,name,unit,quantity,effect));
            }
        }
        workbook.close();
        inputStream.close();
    ...
    public ArrayList<ToaThuoc> getToaThuocFromExcel() throws IOException {
        ...
        while (iterToa.hasNext()){
            ...
            if(!isRowEmpty(nextRow)){
                ...
                listToa.add(new ToaThuoc(presID,name,startDate,endDate,listThuocTrongToa));
            }
        }
        return listToa;
    }
