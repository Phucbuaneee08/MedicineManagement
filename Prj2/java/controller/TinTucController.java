...
import Prj2.java.service.CrawlInfo;
import Prj2.java.model.TinTuc;
import Prj2.java.model.TinTucBox;
...
public class TinTucController {
    ...
    public TinTucController(Controller controller) throws IOException {
        FXMLLoader pane = new FXMLLoader(getClass().getResource("/Prj2/resource/view/TienIch.fxml"));
